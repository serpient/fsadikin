const TicTacToe = {
  ...
  blogLink:
    'https://www.notion.so/Adding-Lite-3-Mode-to-Tic-Tac-Toe-319cdbe091e84328a77dfe5cfe154f16',
  ...
  features: [
    {
      ...
      image: {
        link: require('../assets/ruby_tic_tac_toe_smart_computer.gif'),
        vertical: false
      }
    },
    {
      ...
      image: {
        link: require('../assets/ruby_tic_tac_toe_lite_3.gif'),
        vertical: false
      }
    },
    {
      title: 'Save / Restore Game',
      description: `Utilize serialization to maintain game data integrity, and PostgresDB for storing data.`,
      image: {
        link: require('../assets/ruby_tic_tac_toe_persistence.gif'),
        vertical: false
      }
    }
  ]
