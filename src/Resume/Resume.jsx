    ...
    render() {
        return (
            <object className="resume-object" data={resume} type="application/pdf">
                <iframe title="resume" width={window.innerWidth || window.screen.width} height={window.innerHeight || window.screen.height} className="resume-iframe" src={embeddedGoogleLinkToResume}>
