    ...
    render() {
        return (
            <object className="resume-object" data={resume} type="application/pdf">
                <iframe title="resume" width={window.screen.availWidth} height={window.screen.availHeight - (window.screen.availHeight * .1)} className="resume-iframe" src={embeddedGoogleLinkToResume}>
