      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            render={() => (
              <ProjectPageCreator
                projectData={projects.get('inclusive-maps')}
              />
            )}
          />
          <Route
            ...
            render={() => (
              <ProjectPageCreator projectData={projects.get('tic-tac-toe')} />
            )}
          />
          <Route
            exact={true}
            ...
            render={() => (
              <ProjectPageCreator projectData={projects.get('http-server')} />
            )}
          />
          <Route
            exact={true}
            path="/projects/rebay"
            render={() => (
              <ProjectPageCreator projectData={projects.get('rebay')} />
            )}
          />
          <Route
            exact={true}
            path="/projects/focal"
            render={() => (
              <ProjectPageCreator projectData={projects.get('focal')} />
            )}
          />
          <Route
            exact={true}
            path="/projects/Health-Worker-Data-Alliance"
            render={() => (
              <ProjectPageCreator projectData={projects.get('hwda')} />
            )}
          />
