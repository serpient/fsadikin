      ...
      <React.Fragment>
        <main className="projects-container">
          ...
          <nav className="sub-header">
            <div
              onClick={() => {
                this.toggleProjectType();
              }}
              className={`project-switch ${currTypeIsEng &&
                'project-switch-active'}`}
            >
              <div
                className={`project-type ${currTypeIsEng &&
                  'project-type-active'}`}
              >
                Engineering
              </div>
      ...
      <div className="project" key={'project_' + index}>
        ...
        <div className="project-info">
          ...
          <div className="project-btns">
            <a to={project.liveLink} className="btn-more">
              Live Link
            </a>
            <a to={project.githubLink} className="btn-more">
              GitHub Link
            </a>
            <Link
